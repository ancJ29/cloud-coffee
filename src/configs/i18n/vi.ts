export default {
  ...
  'Success': 'Thành công',
  'Failure': 'Thất bại',
  'Staff attendance status': 'Trạng thái làm việc',
  ...
  'Custom': 'Tùy chỉnh',
  'Date': 'Ngày',
  'Attendance image': 'Ảnh chấm công',
  'Total': 'Tổng cộng',
  'Staff': 'Nhân viên',
  'Owner': 'Quản lý',
  ...
  'Carry over days into next leave year': 'Ngày phép chuyển sang năm sau',
  ...
  'Weekly contracted hours': 'Số giờ làm hàng tuần theo hợp đồng',
  ...
  'How many hours does 1 leave day equate to?': '1 ngày nghỉ bằng bao nhiêu giờ?',
  'Monday': 'Thứ hai',
  'Tuesday': 'Thứ ba',
  'Wednesday': 'Thứ tư',
  'Thursday': 'Thứ năm',
