export default {
  ...
  'Staffs Clocked in': 'Nhân viên đã chấm công vào',
  'Staffs Clocked out': 'Nhân viên đã chấm công ra',
  'Staffs on Leave Today': 'Nhân viên nghỉ phép hôm nay',
  ...
  'HR information': 'Thông tin nhân sự',
  ...
  'Copy': 'Sao chép',
  'Copied': 'Đã sao chép',
  'This staff is a manager of other staffs': 'Nhân viên này là quản lý của nhân viên khác',
  'This staff can manage teams of staffs': 'Nhân viên này có thể quản lý các nhóm nhân viên',
  'This staff is an administrator': 'Nhân viên này là quản trị viên',
  'Can access the Mobile App': 'Có thể truy cập Ứng dụng di động',
  'Can Clock in on Web': 'Có thể Chấm công trên Web',
  'Skip Clock In/Out Notifications for this staff': 'Bỏ qua thông báo chấm công cho nhân viên này',
  'Can submit Manual Timesheet': 'Cho phép gửi bảng chấm công thủ công',
  'Team': 'Nhóm',
  'Are you sure you want this user to have administrator access? This will give them access to all data for your organization':
    'Bạn có chắc chắn muốn người dùng này có quyền truy cập quản trị viên không? Điều này sẽ cấp cho họ quyền truy cập vào tất cả dữ liệu cho tổ chức của bạn',
  'Require GPS on Mobile': 'Yêu cầu GPS trên Điện thoại di động',
  'Direct line manager': 'Quản lý trực tiếp',
  'Join date': 'Ngày nhận việc',
  'End date': 'Ngày thôi việc',
  'Date of birth': 'Ngày sinh',
  'Staff address': 'Địa chỉ nhân viên',
  'Personal contact email': 'Email liên hệ cá nhân',
  'Emergency contact name': 'Tên người liên hệ khẩn cấp',
  'Emergency contact phone number': 'Số điện thoại liên hệ khẩn cấp',
  'Contact type': 'Mối quan hệ với người liên hệ khẩn cấp',
  'Job title': 'Chức danh công việc',
  'Internal staff ID': 'Mã nhân viên nội bộ',
  'Leave entitlement': 'Ngày phép được hưởng',
  'Remaining leave': 'Ngày phép còn lại',
  'Leave year starts on': 'Ngày bắt đầu tính phép năm',
  'Accrues leave?': 'Tích luỹ ngày phép năm? ',
  'Carry over days into next leave year': 'Ngày phép được phép chuyển qua năm sau ',
  'Time off in lieu': 'Nhóm ngày lễ được áp dụng',
  'Annual leave will start on this date': 'Kỳ tính phép năm sẽ bắt đầu vào ngày này',
  'Use this working pattern': 'Áp dụng hình thức làm việc',
  'Weekly contracted hours': 'Giờ làm việc cố định hàng tuần theo hợp đồng',
  'Hourly rate': 'Mức lương theo giờ',
  'How much does this staff get paid per hour?': 'Nhân viên này được trả bao nhiêu một giờ?',
  'Eligible for overtime': 'Được hưởng chế độ làm thêm giờ',
  'Overtime rate multiplier': 'Hệ số lương làm thêm giờ',
  'Specify overtime rates per day': 'Chỉ định Mức lương làm thêm giờ áp dụng cho từng ngày',
  'Works shifts': 'Ca làm việc',
  'Based on your working schedule set, this staff can book leave on Monday, Tuesday, Wednesday, Thursday, Friday':
    'Dựa trên lịch trình làm việc đã thiết lập, nhân viên này có thể đặt lịch nghỉ vào Thứ Hai, Thứ Ba, Thứ Tư, Thứ Năm, Thứ Sáu',
  'Day break': 'Nghỉ giữa giờ',
  'Working hours': 'Giờ làm việc',
  'Overtime rate per day': 'Mức lương làm thêm giờ áp dụng cho từng ngày',
  'Bookable leave days': 'Ngày phép được đăng ký',
  'How many hours does 1 leave day equate to?': 'Một ngày nghỉ phép tương đương với bao nhiêu giờ?',
  'Monday': 'Thứ hai',
  'Tuesday': 'Thứ ba',
  'Wednesday': 'Thứ tư',
  'Thursday': 'Thứ năm',
  ...
  'Saturday': 'Thứ bảy',
  'Sunday': 'Chủ nhật',
  'Add staff break': 'Thêm giờ nghỉ của nhân viên',
  'Day': 'Ngày',
